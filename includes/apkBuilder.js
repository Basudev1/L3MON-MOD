...
//     let javaVersion =
//       javaIndex !== -1 ? output.substring(javaIndex, javaIndex + 27) : "";
//     let openJDKVersion =
//       openJDKIndex !== -1
//         ? output.substring(openJDKIndex, openJDKIndex + 27)
//         : "";
//     if (javaVersion !== "" || openJDKVersion !== "") {
//       if (javaVersion.includes("16.0.2") || openJDKVersion.includes("16.0.2")) {
//         spawn.removeAllListeners();
//         spawn.stderr.removeAllListeners();
//         return callback(null, javaVersion || openJDKVersion);
//       } else
//         return callback(
//           "Wrong Java Version Installed. Detected " +
//             (javaVersion || openJDKVersion) +
//             ". Please use Java 1.8.0",
//           undefined
//         );
...
//         data.substring(data.indexOf("http://"), data.indexOf("?model=")),
//         "http://" + URI + ":" + PORT
//       );
